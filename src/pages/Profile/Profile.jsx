            ...
            <div className="rounded-3xl border border-[#ecdcc8] bg-white shadow-md overflow-hidden">
              ...
              <div className="flex flex-col items-center px-6 pb-6" style={{ marginTop: -48 }}>
                ...
                <div className="w-full mt-5">
                  ...
                  <button
                    type="button"
                    onClick={() => { setError(""); setSuccessMsg(""); setShowPasswordModal(true); }}
          ...
          <div className="bg-white w-full sm:max-w-sm sm:mx-4 sm:rounded-3xl rounded-t-3xl px-6 pt-5 pb-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#de7e52]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
                <p className="text-sm font-bold text-[#1f1f1f]">Change Password</p>
              </div>
              <button

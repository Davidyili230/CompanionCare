  ...
  return (
    <section className="rounded-2xl border border-[#ecdcc8] bg-[#fffaf6] p-4">
      ...
      {!selectedPet ? (
        ...
        <div className="rounded-xl border border-[#f0d7c8] bg-white px-4 py-3 text-sm text-red-500">
          {error}
        </div>
      ) : !hasSuggestions ? (
        <div className="rounded-xl border border-[#f0d7c8] bg-white px-4 py-3 text-sm text-[#8a7d75]">
            ...
            return (
              <CardWrapper
                ...
                {...(item.link
                  ...
                  : {})}
                className="block rounded-xl border border-[#f0d7c8] bg-white p-4 transition hover:shadow-sm"
              >
                <div className="flex items-start gap-3">
                  {item.imageUrl ? (
                    <img
                      src={item.imageUrl}
                      alt={item.name}
                      className="h-20 w-20 rounded-lg border border-[#f0d7c8] object-cover"
                    />
                  ) : null}
